...
export class BackstopClient {
  ...
  constructor(address: string) {
    ...
    this.spec = new ContractSpec([
      ...
      'AAAAAAAAAAAAAAAGZ2V0X3J6AAAAAAAAAAAAAQAAA+oAAAAT',
      'AAAAAAAAAAAAAAAIcG9vbF9lcHMAAAABAAAAAAAAAAxwb29sX2FkZHJlc3MAAAATAAAAAQAAA+0AAAACAAAACwAAAAY=',
      'AAAAAAAAAAAAAAAFY2xhaW0AAAAAAAADAAAAAAAAAARmcm9tAAAAEwAAAAAAAAAOcG9vbF9hZGRyZXNzZXMAAAAAA+oAAAATAAAAAAAAAAJ0bwAAAAAAEwAAAAA=',

...
test('convert xdr to ReserveData', () => {
  const to_convert =
    '';
...
test('reserve estimate data', () => {
  ...
  const result = reserve.estimateData(0.2, 500);
  expect(result).toEqual({
